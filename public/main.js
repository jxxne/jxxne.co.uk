...
for (let i = 0; i < 10; i++) {
    ...
    document.addEventListener("DOMContentLoaded", function() {
      ...
      document.addEventListener("DOMContentLoaded", function() {
        const scrollableDiv = document.getElementById("music");
        const boxRight = document.getElementById("boxright");
        scrollableDiv.addEventListener("scroll", function() {
          if (scrollableDiv.scrollTop >= 5) {
            boxRight.classList.remove("unscrolledy");
          } else {
            boxRight.classList.add("unscrolledy");
          }
        });
      });